...
- 静态推荐：36 个 PNG，包含 16 个彩色图标和 20 个透明品牌 Logo。
- 动态推荐：33 个正方形 GIF，包含轻量循环动画、吉伊卡哇 / 小八热门动画，以及 20 个新增主题动画。
...
- 20 个品牌 Logo 主要来自 Simple Icons；Microsoft、OpenAI、黑鲨和 Hermes Agent 使用各自官方说明或官方项目素材。
- 新增的吉伊卡哇 / 小八 GIF 来自 Tenor 页面；不适合正方形裁切的横幅素材已替换。详细来源和许可说明见 [SOURCES.md](SOURCES.md)。
- 20 个新增轻量 GIF 由仓库中的透明静态图标和自绘几何图形制作，全部为 256 × 256。
